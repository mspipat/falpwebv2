    ...
    <section id="about">
      <div class="container">
        ...
        <div class="col-lg-6 content order-lg-1 order-2">
             ...
             <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
              <p class="text-justify">Shuttle services from Rosario, Batangas City, Lipa, Sto. Tomas, Padre Garcia and Sta. Teresita, San Pablo are provided.</p>
            </div>
        ...
        <div class="row">
          ...
          <div class="row">
           ...
           <!--  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
              <div class="box">
                <div class="icon"><i class="fa fa-trophy"></i></div> 
                  <img src="img/achievements/qcc_japan.jpg" width="300" height="200"></img>
                  <h4 class="title">QCC Cycle 2019</h4>
                  <p class="description"> QCC/Olympic/Kaizen Competition 2019 </p>
              </div>
            </div>
          </div> -->
          </div>
